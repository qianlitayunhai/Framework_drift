        ...
        for i in range(1, len(stream)):
            ...
            if(mudanca_ocorreu == False):
                ...
                if(mudou):
                    ...
                    enxame = memoria.Relembrar_acurado(enxame, janela_alerta.dados, self.lags)
...
def main():
    ...
    w = 0.7
    c = 1
    alg = MP_IDPSO_ELM(dataset, n, lags, qtd_neuronios, numero_particulas, qtd_sensores, w, c)
