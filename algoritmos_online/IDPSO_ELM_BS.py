    ...
    def Executar(self, grafico = None):
        ...
        for i in range(1, len(stream)):
            ...
            if(mudanca_ocorreu == False):
                ...
                # variavel para armazenar as solucoes
                ativadores = [False] * 2
                
                #computando o comportamento para a janela de predicao, para somente uma instancia - media e desvio padrão
                ativadores[0] = b.monitorar(janela_predicao.dados, stream[i:i+1], enxame, i)
                ativadores[1] = s.monitorar(loss, i, False)
