...
class Grafico():
    ...
    def Plotar_graficos(self, stream, predicoes_vetor, deteccoes, alarmes, erro_stream_vetor, n, atrasos, falsos_alarmes, tempo_execucao, MAE=None, nome = None):
        '''
    ...
    def Plotar_graficos_series_fin(self, stream, predicoes_vetor, deteccoes, alarmes, erro_stream_vetor, n, atrasos, falsos_alarmes, tempo_execucao, MAE=None, nome=None):
        '''
        Metodo para plotar tanto o grafico de previsao, erro no data stream e as deteccoes das series do artigo ICTAI
        :param grafico: variavel booleana
        :param stream: data stream
